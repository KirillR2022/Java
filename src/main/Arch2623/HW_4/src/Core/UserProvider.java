...
public class UserProvider {
     ...
     */
    public int                                                                                                createClient(String userName, int passwordHash, int phone, long cardNumber) throws RuntimeException {
        int id = clientRepository.create(userName, passwordHash, phone, cardNumber);
        return id;
    }
