...
public class Start extends EnterData {
    ...
    private void register() {
        ...
        System.out.print("Enter phone number (111-11-11 -> 999-99-99): ");
        int phone = inputInt(111_11_11, 999_99_99);
        ...
        int id;
        try {
            id = customer.getUserProvider().createClient(userName, passwordHash, phone, cardNumber);
            customer.setUser(Authentication.authentication(customer.getUserProvider(), userName, passwordHash));
        } catch (RuntimeException ex) {
            System.out.println("FAIL");
            System.out.println(ex.getMessage());
