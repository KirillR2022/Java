...
public class UserRepository implements IUserRepo {
    ...
    private UserRepository() {
        ...
        clients.add(new User(1, "Ivan", "1111".hashCode(), 1112233, 2));
        clients.add(new User(2, "Vasiliy", "2222".hashCode(), 2223344, 3));
        clients.add(new User(3, "Fedor", "3333".hashCode(), 3334455, 4));
        clients.add(new User(4, "Grigoriy", "4444".hashCode(), 4445566, 5));
    }
    ...
    @Override
    public int create(String userName, int passwordHash, int phone, long cardNumber) throws RuntimeException {
        int id = clients.size() + 1;
        User client = new User(id, userName, passwordHash, phone, cardNumber);
